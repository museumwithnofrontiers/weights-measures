...
The **Museum With No Frontiers — Weights and Measures** gallery, built from the published
dataset `@museumwnf/weights-measures-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/weights-measures-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/weights-measures/> through the reusable workflows in

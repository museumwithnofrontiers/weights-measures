...
const about = {
  body: 'weightsMeasures.about.body',
...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'weights-measures',
  ...
  home: {
    title: 'weightsMeasures.identity.title',
    intro: 'weightsMeasures.home.intro',
    cards: [
      {
        title: 'weightsMeasures.nav.catalogue',
        description: 'weightsMeasures.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'weightsMeasures.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'weightsMeasures.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'weightsMeasures.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'weightsMeasures.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'weightsMeasures.partnerObjects.emptyPartner',
  //         emptyInstitution: 'weightsMeasures.partnerObjects.emptyInstitution',
  //         institutionSummary: 'weightsMeasures.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'weightsMeasures.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'weightsMeasures.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance

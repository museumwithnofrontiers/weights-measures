...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Weights and measures',
  ...
  // one entry for every project id `npm pack @museumwnf/weights-measures-data`
  // carries in `manifest.projects` (checked 2026-09-19, weights-measures-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/weights-measures' },

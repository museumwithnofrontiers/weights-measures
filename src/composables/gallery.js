...
// `useGalleryData.js` used to be byte-identical local copies of what weights-measures
...
// legacy project key, no UUID — weights-measures shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (weights-measures-data 1.0.11+), an outside
